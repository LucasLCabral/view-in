...
CREATE TABLE IF NOT EXISTS job_report (
    id_job_report BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS audio_files (
    id_audio_file BIGINT AUTO_INCREMENT PRIMARY KEY,
